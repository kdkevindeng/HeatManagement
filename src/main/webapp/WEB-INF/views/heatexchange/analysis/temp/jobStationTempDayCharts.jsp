    ...
    <script>
        ...
        function initchart(axisData) {
            ...
            option = {
                ...
                legend: {
                    x:'left',
                    data:['一次出水温度','一次回水温度','二次出水温度','二次回水温度']
                },
                toolbox: {
                    feature: {
                        dataZoom: {
...
<body>
	<div class="container-fluid">
        ...
        <ul class="nav nav-tabs">
            <li ><a href="${ctx}/analysis/press/jobStationPressDay/chart">压力曲线</a></li>
            <li class="active"><a href="${ctx}/analysis/temp/jobStationTempDay/chart">温度曲线</a></li>
        </ul>
