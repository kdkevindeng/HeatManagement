    ...
    <script>
        ...
        function initchart(axisData) {
            ...
            option = {
                ...
                legend: {
                    x:'left',
                    data:['一次出水压力','一次回水压力','二次出水压力','二次回水压力']
                },
                toolbox: {
                    feature: {
                        dataZoom: {
...
<body>
	<div class="container-fluid">
        ...
        <ul class="nav nav-tabs">
            <li class="active"><a href="${ctx}/analysis/press/jobStationPressDay/chart">压力曲线</a></li>
            <li ><a href="${ctx}/analysis/temp/jobStationTempDay/chart">温度曲线</a></li>
        </ul>
