...
<body>
	...
	<form:form id="searchForm" modelAttribute="jobStationEnergyConsumeMonth" action="${ctx}/analysis/energy/jobStationEnergyConsumeWeek/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="jobStationEnergyConsumeWeek">
			<tr>
				...
				<td>
					<fmt:formatDate value="${jobStationEnergyConsumeWeek.time}" pattern="yyyy-MM-dd"/>
				</td>
