...
<head>
    ...
    <script>
        ...
        function query() {
//            $("#stationCode")
            $.post("${ctx}/analysis/energy/jobStationEnergyConsumeMonth/chart/data",
...
<body>
	<div class="container-fluid">
        ...
        <ul class="nav nav-tabs">
            <li ><a href="${ctx}/analysis/energy/jobStationEnergyConsumeMonth/">能耗分析列表</a></li>
            <li class="active"><a href="${ctx}/analysis/energy/jobStationEnergyConsumeMonth/chart">能耗分析图</a></li>
        </ul>
