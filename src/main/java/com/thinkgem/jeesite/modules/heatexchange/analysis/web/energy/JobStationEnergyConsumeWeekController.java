 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/analysis/energy/jobStationEnergyConsumeWeek")
public class JobStationEnergyConsumeWeekController extends BaseController {
	...
	@RequiresPermissions("analysis:energy:jobStationEnergyConsumeWeek:view")
	...
	public String list(JobStationEnergyConsumeMonth jobStationEnergyConsumeMonth, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "heatexchange/analysis/energy/jobStationEnergyConsumeWeekList";
	}
	...
	public String chart(Model model) {
		model.addAttribute("stationList", this.jobStationService.findList(new JobStation()));
		return "heatexchange/analysis/energy/jobStationEnergyConsumeWeekCharts";
	}
	@RequiresPermissions("analysis:energy:jobStationEnergyConsumeWeek:view")
	@ResponseBody
	...
	public String form(JobStationEnergyConsumeMonth jobStationEnergyConsumeMonth, Model model) {
		model.addAttribute("jobStationEnergyConsumeWeek", jobStationEnergyConsumeMonth);
		return "heatexchange/analysis/energy/jobStationEnergyConsumeWeekForm";
	}

	@RequiresPermissions("analysis:energy:jobStationEnergyConsumeWeek:edit")
	...
	public String save(JobStationEnergyConsumeMonth jobStationEnergyConsumeMonth, Model model, RedirectAttributes redirectAttributes) {
		...
		addMessage(redirectAttributes, "保存能耗分析-周成功");
		return "redirect:"+Global.getAdminPath()+"/analysis/energy/jobStationEnergyConsumeWeek/?repage";
	}
	...
	public String delete(JobStationEnergyConsumeMonth jobStationEnergyConsumeMonth, RedirectAttributes redirectAttributes) {
		...
		addMessage(redirectAttributes, "删除能耗分析-周成功");
		return "redirect:"+Global.getAdminPath()+"/analysis/energy/jobStationEnergyConsumeWeek/?repage";
	}
