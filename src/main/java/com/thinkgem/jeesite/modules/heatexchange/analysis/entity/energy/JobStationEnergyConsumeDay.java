 ...
 * @version 2017-11-17
 */
public class JobStationEnergyConsumeDay extends DataEntity<JobStationEnergyConsumeDay> {
	...
	public JobStationEnergyConsumeDay() {
		super();
	}

	public JobStationEnergyConsumeDay(String id){
		super(id);
	}
