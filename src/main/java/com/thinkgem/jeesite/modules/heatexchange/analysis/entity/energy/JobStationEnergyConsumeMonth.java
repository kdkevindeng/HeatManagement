 ...
 * @version 2017-11-27
 */
public class JobStationEnergyConsumeMonth extends DataEntity<JobStationEnergyConsumeMonth> {
	...
	public JobStationEnergyConsumeMonth() {
		super();
	}

	public JobStationEnergyConsumeMonth(String id){
		super(id);
	}
